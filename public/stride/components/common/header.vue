    ...
    <div class="az-header az-header-dashboard-six">
        <div class="container-fluid">
          ...
          <div class="az-header-right">
            ...
            <div class="dropdown az-header-notification header-notification" v-on:click="notificationToggle">
            ...
            <div class="dropdown az-profile-menu user-profile" v-on:click="profileToggle">
